...
const navItems = [
    ...
    { href: "/admin/chefs", label: "Kullanıcılar", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" },
    ...
    { href: "/admin/definitions/groups", label: "Personel Grupları", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
    ...
    { href: "/admin/statistics", label: "İstatistikler", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
    ...
    { href: "/admin/import/trainings", label: "Eğitim Import", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
];
        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-gray-900 text-white h-16 flex items-center justify-between px-4">
                ...
                <div className="flex items-center space-x-2">
                    <Image src="/tav-guvenlik-logo.png" alt="TAV Güvenlik Logo" width={100} height={32} className="h-6 w-auto" />
