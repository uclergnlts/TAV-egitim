...
export default function DocumentsPage() {
    const [documents, setDocuments] = useState<Definition[]>([]);
    ...
    const loadData = async () => {
        try {
            ...
            const res = await fetch("/api/definitions/documents?all=true");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const url = "/api/definitions/documents";
    ...
    const handleToggleStatus = async (item: Definition) => {
        ...
        try {
            ...
            const res = await fetch("/api/definitions/documents", {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold text-gray-800">Belge Türleri Yönetimi</h1>
